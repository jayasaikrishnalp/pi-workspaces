...
Operator-defined ordered runbooks. Each step references a skill or another workflow; stored on disk as <kbRoot>/workflows/<name>/WORKFLOW.md and surfaced as graph nodes with step edges. Workflows are first-class data here; an executor lands in a later phase.
