...
Operator-defined agents that compose multiple skills under a shared persona. Stored on disk as <kbRoot>/agents/<name>/AGENT.md and surfaced as graph nodes with composes edges to their constituent skills.
