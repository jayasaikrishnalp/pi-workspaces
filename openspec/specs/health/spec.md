...
Liveness probe for the workspace process. Exists so deployment and supervision tooling (start.sh, systemd, Tailscale health checks) can confirm the process is up and reachable without authenticating or invoking any business logic.
